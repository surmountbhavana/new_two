...
const CLIENT_ID = '381919059270-p7ao4727mqt8ve2qre8ac9sqbe6bifrs.apps.googleusercontent.com';
const CLIENT_SECRET = '_zrYaaFWQkJjnZmBzyS1uRw_';
const REDIRECT_URI = 'http://localhost/test/Index.php';
session_start();
...
<div>
    ...
    */
    if (isset($authUrl)) {
        echo "<a class='login' href='" . $authUrl . "'><img src='sign_in_button.png' height='150px'/></a>";
    } else {
        echo "ID: {$id} <br>";
        echo "Name: {$name} <br>";
        echo "Email: {$email } <br>";
	...
	$_SESSION['redirurl'] = "http://localhost/test/project1.php";
	$url = $_SESSION['redirurl'];
	echo '<a href="'.$url.'"><h1> Click to upload Video</h1></a>';
